...
In [2]: script = '<script>alert("Hello World")</script>'

In [3]: safe_js = html.escape(script)

In [4]: safe_js
Out[4]: '&lt;script&gt;alert(&quot;Hello World&quot;)&lt;/script&gt;'

In [5]: script2 = html.unescape(safe_js)

In [6]: script2
Out[6]: '<script>alert("Hello World")</script>'
```
...
6. for 标签
    ...
    2. 内置变量 - forloop
        ...
        | forloop.revcounter0 | revcounter0值的倒序 |
